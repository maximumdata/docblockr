...
module.exports = {
    config: {
        ...
        add_and_find_namespace: {
            type: 'boolean',
            default: true,
            title: 'Auto find last @namespace',
            description: 'Attempt to search for the most recently declared @namespace'
        },
        add_memberof: {
            type: 'boolean',
            default: true,
            title: 'Auto insert @memberof',
            description: 'Toggle insertion of @memberof into comment',
        }
    },
